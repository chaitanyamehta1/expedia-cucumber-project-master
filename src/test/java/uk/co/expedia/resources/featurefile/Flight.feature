Feature: Flight Destination and Search Flight Functionality
  ...
  Scenario Outline: Verify user should find destination according there choice
    ...
    Examples:
      ...
      | London      | Ahmedabad | 20/12/2020     | 10/02/2021     | Select your departure to Ahmedabad |
      | Birmingham  | Delhi     | 10/12/2020     | 10/01/2021     | Select your departure to Delhi     |
      | Ahmedabad   | Mumbai    | 18/12/2020     | 10/01/2021     | Select your departure to Mumbai    |
